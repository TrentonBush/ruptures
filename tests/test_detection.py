...
@pytest.mark.parametrize(u"algo", [Binseg, BottomUp, Dynp, Pelt, Window])
...
@pytest.mark.parametrize(u"algo, model", product([Binseg, BottomUp, Window], [u"l1", u"l2", u"ar", u"normal", u"rbf"]))
...
@pytest.mark.parametrize(u"algo, model", product([Dynp, Pelt], [u"l1", u"l2", u"ar", u"normal", u"rbf"]))
def test_model_1D_bis(signal_bkps_1D, algo, model):
    signal, bkps = signal_bkps_1D
    algo().fit_predict(signal, 1)


@pytest.mark.parametrize(u"algo, model", product([Dynp, Pelt, Binseg, BottomUp, Window], [u"l1", u"l2", u"ar", u"normal", u"rbf"]))
def test_model_1D_constant(signal_bkps_1D_constant, algo, model):
    signal, bkps = signal_bkps_1D_constant
    algo().fit_predict(signal, 1)


@pytest.mark.parametrize(u"algo, model", product([Binseg, BottomUp, Window], [u"l1", u"l2", u"linear", u"normal", u"rbf"]))
...
@pytest.mark.parametrize(u"algo, model", product([Dynp, Pelt], [u"l1", u"l2", u"linear", u"normal", u"rbf"]))
def test_model_5D_bis(signal_bkps_5D, algo, model):
    signal, bkps = signal_bkps_5D
    algo().fit_predict(signal, 1)


@pytest.mark.parametrize(u"algo", [Binseg, BottomUp, Window, Dynp, Pelt])
...
def test_pass_param_to_cost(signal_bkps_1D, algo):
    signal, bkps = signal_bkps_1D
    algo(model=u"ar", params={u"order": 10}).fit_predict(signal, 1)
